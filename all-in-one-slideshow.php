...
Plugin URI: http://lizatom.com/wordpress-plugin/all-in-one-slideshow/
...
TODO: scripts doesnt load on search page
*/
...
function aio_slideshow_images_admin() { ?>
    ...
    5. If you are still having a problem, let me know in the forum on <a href="http://lizatom.com/">my site</a> please. 
    </p>
           ...
           <div id="side-sortables" class="meta-box-sortables ui-sortable">
             <div id="submitdiv" class="postbox ">
                ...
                <div class="inside">          
                 ...
                 <p>For help, please visit <a href="http://lizatom.com/wordpress-plugin/all-in-one-slideshow/">official plugin's site</a>.</p>
              ...
              <div id="submitdiv" class="postbox ">
                ...
                <div class="handlediv" title="Click to toggle"><br /></div>
                -->
                <h3 class='hndle'><span>My Other WordPress Stuff</span></h3>
                <div class="inside">               
                 <div class="misc-pub-section">  
                 <p style="text-align: left;">If you like this plugin, maybe you'll be interested in my other plugins &amp; themes. </p>               
                 <p style="text-align: center;">
                 <a href="http://lizatom.com/"><img src="http://lizatom.com/temp/250x250.jpg" /></a></p>                 
                 </div>
...
function aio_slideshow_scripts() {
	...
	if(!is_admin())
    //wp_enqueue_script('jquery-1.6.1', WP_CONTENT_URL.'/plugins/all-in-one-slideshow/jquery-1.6.1.js', '', '1.6.1', false);
	wp_enqueue_script('cycle', WP_CONTENT_URL.'/plugins/all-in-one-slideshow/jquery.cycle.all.min.js', array('jquery'), '', false);
    wp_enqueue_script('easing', WP_CONTENT_URL.'/plugins/all-in-one-slideshow/jquery.easing.1.3.js', array('jquery'), '', false);
    wp_enqueue_script('cufon-yui', WP_CONTENT_URL.'/plugins/all-in-one-slideshow/cufon/cufon-yui.js', '', '', false);
    wp_enqueue_script('cufon-font', WP_CONTENT_URL.'/plugins/all-in-one-slideshow/cufon/fonts/' . $font_name, '', '', false);
}
